...
print("\nRANDOM\n")
run_options.examples_to_augment_prompt_type=llm_pipeline.ExampleStrategies.RANDOM # "RANDOM", "DYNAMIC", "NONE", "EMBEDDED" "TFIDF" all options     
run_options.examples_weight_of_error_message = 0.5 # Wieght of the erro message in case of DYNAMIC in relantion with code                                 
run_options.number_examples_to_add=3
perform_prompt_localizaiton_and_inferece(llmhaiku, run_options, global_options)
perform_verification(llmhaiku, run_options, global_options)
...
print("\nEMBEDDED\n")
run_options.examples_to_augment_prompt_type=llm_pipeline.ExampleStrategies.EMBEDDED# "RANDOM", "DYNAMIC", "NONE", "EMBEDDED" "TFIDF" all options     
run_options.examples_weight_of_error_message = 0.5 # Wieght of the erro message in case of DYNAMIC in relantion with code                                 
run_options.number_examples_to_add=3
perform_prompt_localizaiton_and_inferece(llmhaiku, run_options, global_options)
perform_verification(llmhaiku, run_options, global_options)
...
print("\nTFIDF\n")
run_options.examples_to_augment_prompt_type=llm_pipeline.ExampleStrategies.TFIDF # "RANDOM", "DYNAMIC", "NONE", "EMBEDDED" "TFIDF" all options     
run_options.examples_weight_of_error_message = 0.5 # Wieght of the erro message in case of DYNAMIC in relantion with code                                 
run_options.number_examples_to_add=3
perform_prompt_localizaiton_and_inferece(llmhaiku, run_options, global_options)
perform_verification(llmhaiku, run_options, global_options)
