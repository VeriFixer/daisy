...
Usage:
    python -m src_new.datasets.full_dataset_creator
"""

from src_new.config import DAFNY_ASSERTION_DATASET
from src_new.datasets.dafny_get_all_assertions import dafny_get_all_assertions
from src_new.datasets.dafny_dataset_generator import dafny_dataset_generator
