...
from src_new.utils.assertion_method_classes import FileInfo, MethodInfo
...
def test_real_dataset_non_ascii_assertion_removal() -> None:
    ...
    """
    from src_new.utils.assertion_method_classes import AssertionInfo
    from src_new.config import ASSERTION_PLACEHOLDER
