...
from src_new.utils.dafny_runner import (
    DafnyStatus,
    build_dafny_command,
    parse_dafny_output,
)
from src_new.datasets.assertion_test_generator import (
...
class TestGenerateDatasetForProgram:
    @patch("src_new.datasets.dafny_dataset_generator.run_dafny_from_text")
    @patch("src_new.datasets.dafny_dataset_generator.extract_assertion")
    @patch("src_new.datasets.dafny_dataset_generator.process_assertions_method")
    def test_skips_non_verified_program(self, mock_process, mock_extract, mock_run, tmp_path):
        ...
        from src_new.datasets.dafny_dataset_generator import generate_dataset_for_program
...
class TestFullDatasetCreatorImport:
    def test_importable(self):
        ...
        from src_new.datasets import full_dataset_creator
