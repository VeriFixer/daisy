...
from src_new.config import VerificationConfig, VerificationType
from src_new.daisy.verification.base import VerificationResult
from src_new.daisy.verification.parallel_combo import (
    ParallelComboVerification,
    zip_with_empty_indexed,
)
from src_new.utils.external_cmd import Status
...
class TestEarlyStopOnFirstVerified:
    @patch("src_new.daisy.verification.parallel_combo.run_external_cmd")
